...
pub struct Data {
    ...
    /// The asterisk must b`e the first character of the host attribute. For example, the host `google.co.` is invalid because the asterisk wildcard is not the first character.
    /// 
