...
pub struct Service {
    ...
    /// same user ID can start the service or bind to it. The default value depends on
    ...
    /// user-initiated action`] related to device location. You can assign multiple
    ...
    /// the [`<manifest>`] element. Once you publish your application, you
    ...
    /// you to spread your application across multiple processes. If the name assigned
    /// to this attribute begins with a colon `(':')`, a new process, private to the
